...
pick_action = pick.get_action_level_1_for_single_object(pick.scene_mngr.scene, "hanoi_disk_5")
...
for pick_scene in pick.get_possible_transitions(pick.scene_mngr.scene, pick_action):
    ...
    if pick_joint_path:
        place_action = place.get_action_level_1_for_single_object("table", "hanoi_disk_5", pick_scene.robot.gripper.grasp_pose, scene=pick_scene)
