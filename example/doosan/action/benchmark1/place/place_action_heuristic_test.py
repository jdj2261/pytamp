...
place = PlaceAction(
    benchmark1.scene_mngr, n_samples_held_obj=0, n_samples_support_obj=0, n_directions=7
)
...
for pick_scene in pick.get_possible_transitions(
    ...
    for release_pose, obj_pose in place_action[place.info.RELEASE_POSES]:
        ...
        # place.scene_mngr.render.render_gripper(ax, place.scene_mngr.scene.robot, pose=release_pose[place.move_data.MOVE_release])
