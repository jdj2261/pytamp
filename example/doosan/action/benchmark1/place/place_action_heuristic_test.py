...
pick_action = pick.get_action_level_1_for_single_object(pick.scene_mngr.init_scene, "A_box")
...
for pick_scene in pick.get_possible_transitions(pick.scene_mngr.init_scene, pick_action):
    place_action = place.get_action_level_1_for_single_object("tray_red", "A_box", pick_scene.robot.gripper.grasp_pose, scene=pick_scene)
