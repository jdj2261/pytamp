...
robot.init_qpos = controller_config["init_qpos"]
...
grasp_pose[:3, 3] = grasp_pose[:3, 3] - [0.2, 0, 0]

target_thetas = scene_mngr.scene.robot.get_result_qpos(robot.init_qpos, grasp_pose)
