...
test1_box_pose = Transform(pos=np.array([0.6, 0.2, 0.77 + 0.18]))
test2_box_pose = Transform(pos=np.array([0.6, 0.2, 0.77 + 0.24]))
test3_box_pose = Transform(pos=np.array([0.6, 0.2, 0.77 + 0.30]))
...
yellow_cube_mesh = get_object_mesh('ben_cube.stl', 0.06)
...
# scene_mngr.scene.logical_states["E_box"] = {scene_mngr.scene.logical_state.on : scene_mngr.scene.objs["D_box"]}
# scene_mngr.scene.logical_states["F_box"] = {scene_mngr.scene.logical_state.on : scene_mngr.scene.objs["E_box"]}
