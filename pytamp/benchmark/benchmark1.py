...
class Benchmark1(Benchmark):
    ...
    def _load_objects(self):
        ...
        D_box_pose = Transform(pos=np.array([0.6, 0.2, table_height + abs(self.box_mesh.bounds[0][2]) + 0.073 + box_height] ))
        E_box_pose = Transform(pos=np.array([0.6, -0.2, table_height + abs(self.box_mesh.bounds[0][2])+ 0.073 + box_height]))
        F_box_pose = Transform(pos=np.array([0.6, 0, table_height + abs(self.box_mesh.bounds[0][2])+ 0.073 + box_height]))
        ...
        H_box_pose = Transform(pos=np.array([0.8, 0.2, table_height + abs(self.box_mesh.bounds[0][2])+ 0.073]))
