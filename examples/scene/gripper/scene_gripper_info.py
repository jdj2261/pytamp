...
scene_mngr.render_objects_and_gripper(ax, robot_color=np.array([1.0, 0.0, 0.0, 1.0]))

scene_mngr.set_gripper_tcp_pose(scene_mngr.scene.robot.init_fk["right_gripper"].h_mat)
scene_mngr.render_objects_and_gripper(ax, robot_color=np.array([0.0, 1.0, 0.0, 1.0]))
