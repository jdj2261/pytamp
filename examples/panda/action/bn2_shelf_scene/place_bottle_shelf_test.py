...
scene_mngr.add_object(name="shelf_9", gtype="mesh", gparam=shelf_9_mesh, h_mat=shelf_pose.h_mat, color=[1.0, 0, 1.0])
scene_mngr.add_robot(robot, robot.init_qpos)

scene_mngr.scene.logical_states["shelf_9"] = {scene_mngr.scene.logical_state.on : scene_mngr.scene.objs["table"]}
