...
pick = PickAction(benchmark4.scene_mngr, n_contacts=3, n_directions=5, retreat_distance=0.1)
...
for pick_action in pick_actions:
    for pick_scene in pick.get_possible_transitions(pick.scene_mngr.init_scene, action=pick_action):
