...
place = PlaceAction(
    benchmark4.scene_mngr, n_samples_held_obj=0, n_samples_support_obj=0, n_directions=10
)
...
for pick_scene in pick.get_possible_transitions(pick.scene_mngr.init_scene, pick_action):
    place_action = place.get_action_level_1_for_single_object(
        "hanoi_disk_1", "hanoi_disk_2", pick_scene.robot.gripper.grasp_pose, scene=pick_scene
    )
