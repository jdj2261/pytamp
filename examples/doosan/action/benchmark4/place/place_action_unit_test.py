...
surface_points_for_held_obj = list(place.get_surface_points_for_held_obj("hanoi_disk_5"))
...
eef_poses = list(pick.get_all_grasp_poses("hanoi_disk_5"))

# Add heuristic
eef_poses.extend(list(pick.get_grasp_pose_from_heuristic("hanoi_disk_5")))
