...
for pick_scene in pick.get_possible_transitions(pick.scene_mngr.init_scene, pick_action):
    ...
    for release_pose, obj_pose in place_action[place.info.RELEASE_POSES]:
        ...
        place.scene_mngr.render_object(ax, place.scene_mngr.scene.objs["goal_bottle"], obj_pose)
        place.scene_mngr.render_gripper(
            ax, benchmark2.scene_mngr.scene, pose=release_pose[place.move_data.MOVE_release]
        )
