...
place = PlaceAction(benchmark3.scene_mngr, n_samples_held_obj=0, n_samples_support_obj=30)
    ...
    for pick_scene in pick.get_possible_transitions(pick.scene_mngr.scene, action=pick_action):
        ...
        for place_action in place_actions:
            ...
            for place_scene in list(place.get_possible_transitions(scene=pick_scene, action=place_action)):
                ...
                place.scene_mngr.render_object(ax, place_scene.objs[place_scene.pick_obj_name], pose=place_scene.objs[place_scene.pick_obj_name].h_mat)
