...
linearplot_with_confidence(
    x_list, perturb_level_2_mean_list, perturb_level_2_std_list, "PBAI", ">", "m"
)
linearplot_with_confidence(
    x_list, uct_level_2_mean_list, uct_level_2_std_list, "UCT", "v", "c"
)
linearplot_with_confidence(
    x_list, bai_ucb_level_2_mean_list, bai_ucb_level_2_std_list, "BAI-UCB", "o", "g"
)
linearplot_with_confidence(
    x_list, random_level_2_mean_list, random_level_2_std_list, "Random", "^", "r"
)
